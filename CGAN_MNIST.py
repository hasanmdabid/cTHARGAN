...
import os
#os.chdir(r"/home/abidhasan/Documents/TimeGAN Tensorflow 2/Conditional GAN/python")
...
def generator(latent_dim, in_shape=(7, 7, 1), n_cats=10):
    ...
    # Hidden Layer 1
    g = Conv2DTranspose(filters=128, kernel_size=(4, 4), strides=(2, 2), padding='same',
                        name='Generator-Hidden-Layer-1')(concat)
    g = ReLU(name='Generator-Hidden-Layer-Activation-1')(g)

    # Hidden Layer 2
    g = Conv2DTranspose(filters=128, kernel_size=(4, 4), strides=(2, 2), padding='same',
                        name='Generator-Hidden-Layer-2')(g)
    ...
    output_layer = Conv2D(filters=1, kernel_size=(7, 7), activation='tanh', padding='same',
                          name='Generator-Output-Layer')(g)
...
gen_model.summary()
# plot_model(gen_model, show_shapes=True, show_layer_names=True, dpi=400, to_file='/home/abidhasan/Documents/TimeGAN Tensorflow 2/Conditional GAN/python/data/generator_structure.png')
...
def discriminator(in_shape=(28, 28, 1), n_cats=10):
    ...
    # Hidden Layer 1
    h = Conv2D(filters=64, kernel_size=(3, 3), strides=(2, 2), padding='same', name='Discriminator-Hidden-Layer-1')(
        concat)
    ...
    h = MaxPool2D(pool_size=(3, 3), strides=(2, 2), padding='valid', name='Discriminator-MaxPool-Layer-2')(
        h)  # Max Pool

    # Flatten and Output Layers
    h = Flatten(name='Discriminator-Flatten-Layer')(h)  # Flatten the shape
    h = Dropout(0.2, name='Discriminator-Flatten-Layer-Dropout')(
        h)  # Randomly drop some connections for better generalization
...
# Show model summary and plot model diagram
dis_model.summary()
# plot_model(dis_model, show_shapes=True, show_layer_names=True, dpi=400, to_file='/home/abidhasan/Documents/TimeGAN Tensorflow 2/Conditional GAN/python/data/discriminator_structure.png')
...
# Show model summary and plot model diagram
gan_model.summary()
# plot_model(gan_model, show_shapes=True, show_layer_names=True, dpi=400, to_file='/home/abidhasan/Documents/TimeGAN Tensorflow 2/Conditional GAN/python/data/dcgan_structure.png')
...
#  3@ generate fake images with the generator model

# Set up a function to sample real images

def real_samples(dataset, categories, n):  # Set up a function to sample real images
...
# ----------------------------------------->Step 6<-------------------------------------------------------------------
# ===============================Train the model and display some results=============================================
...
# -------------------------------------------> Step 7<-----------------------------------------------------------------
# =================================Save the model and use to it to generate images=====================================

# Save the generator model

# We need to compile the generator to avoid a warning. This is because we have previously only compiled within the
# larger cDCGAN model
...
gen_model.save('/home/abidhasan/Documents/TimeGAN Tensorflow 2/Conditional GAN/python/data/cgan_generator.h5')
...
model = load_model('/home/abidhasan/Documents/TimeGAN Tensorflow 2/Conditional GAN/python/data/cgan_generator.h5')
